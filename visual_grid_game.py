...
class VisualGridHuntGame:
    ...
    def __init__(self, width=10, height=10, num_food=10, num_opponents=2, custom_walls=None, num_traps=3):
        ...
        # Declare new trap collection attribute
        self.toxic_traps = set()
        # Populate with coordinate tuples safely avoiding position (0, 0), walls, and food
    ...
    def execute_action(self, action: str):
        ...
        # Check if updated agent_pos intersects with toxic_traps
...
class GridGameGUI:
    ...
    def draw_grid(self):
        ...
        # Iterate through traps to render custom purple shapes on the canvas
        for tx, ty in self.env.toxic_traps:
            offset = self.cell_size * 0.2
            x1 = tx * self.cell_size + offset
            y1 = (self.env.height - 1 - ty) * self.cell_size + offset
            self.canvas.create_rectangle(x1, y1, x1 + self.cell_size * 0.6, y1 + self.cell_size * 0.6, fill="#7c3aed",
                                         outline="#5b21b6")
